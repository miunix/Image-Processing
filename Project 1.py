...
while(p == -1):
    ...
    if case == 'a':
        ...
        if choice == '1':
            ...
            image_r180 = im.transpose(Image.ROTATE_180)
            image_r180.show()
        ...
        if choice == '1':
            ...
            print("\nMode of Image: ", grayscale.mode)
            grayscale.show()
            grayscale.save("new_image.jpg")
        elif choice == '2':
            rgb = im.convert("RGB")
            print("\nMode of Image: ", rgb.mode)
            rgb.show()
            rgb.save("new_image.jpg")
        elif choice == '3':
            cmyk = im.convert("CMYK")
            print("\nMode of Image: ", cmyk.mode)
            cmyk.show()
            cmyk.save("new_image.jpg")
